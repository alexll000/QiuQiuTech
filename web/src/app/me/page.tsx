    ...
    <SiteShell activePath="/me">
      <section className="rounded-[34px] border border-border bg-white px-6 py-7 shadow-[0_20px_54px_rgba(22,43,117,0.05)] sm:px-8">
        ...
        <div className="mt-8 grid gap-5 xl:grid-cols-[260px_1fr]">
          <aside className="rounded-[30px] border border-border bg-white p-6 shadow-[0_14px_38px_rgba(22,43,117,0.04)]">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-copy-soft">
              Navigation
            </p>
          ...
          <div className="grid gap-5">
            <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              {dashboard.overviewCards.map(({ title, description }, index) => (
                <article
                  key={title}
                  className={`rounded-[26px] border p-5 shadow-[0_12px_32px_rgba(22,43,117,0.04)] ${
            ...
            <section className="grid gap-5 xl:grid-cols-[1.02fr_0.98fr]">
              <article className="rounded-[30px] border border-border bg-white p-6 shadow-[0_14px_38px_rgba(22,43,117,0.05)] sm:p-7">
